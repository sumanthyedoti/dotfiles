return {
  ...
  config = function()
    ...
    vim.keymap.set("v", "<localleader>oa", function()
      require("opencode").ask("@selection: ")
    end, { desc = "Ask opencode about selection" })
    vim.keymap.set("n", "<localleader>on", function()
      require("opencode").command("session_new")
    end, { desc = "New opencode session" })
    vim.keymap.set("n", "<localleader>oy", function()
    ...
    vim.keymap.set({ "n", "v" }, "<localleader>os", function()
      require("opencode").select()
    end, { desc = "Select opencode prompt" })

    -- Example: keymap for custom prompt
    vim.keymap.set("n", "<localleader>oe", function()
